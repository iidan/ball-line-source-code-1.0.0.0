...
function (_Phaser$GameObjects$G) {
  ...
  _createClass(Player, [{
    ...
    value: function setupSprite(key, depth) {
      var spr = this._scene.physics.add.image(this._x, this._y, key).setScale(.15 * this._scene.GameSpriteScale).setOrigin(.5, .55);
  ...
  _createClass(Player_Ball, [{
    ...
    value: function setupSprite() {
      ...
      if (!this._isBomb) {
        ...
        spr = this._scene.physics.add.image(this._x, this._y, String(s)).setScale(0).setOrigin(.5);
        offsetY = spr.height * .35 * .5;
      } else {
        spr = this._scene.physics.add.image(this._x, this._y, 'Bomb').setScale(0).setOrigin(.5, .64);
    ...
    value: function update() {
      if (!this._scene.inWorldBounds(this._sprite) || this._RM.IsGameOver) {
        ...
        this.animationManagment(.105 * this._scene.GameSpriteScale);
  ...
  _createClass(MenuUI, [{
    ...
    value: function setupUI() {
      this._ui = {
        ...
        topCoin: this.setupButton('Coin', .1, 400, 45),
...
function (_Phaser$GameObjects$G) {
  ...
  _createClass(Ball, [{
    ...
    value: function setupSprite() {
      ...
      var spr = this._scene.physics.add.image(0, 0, 'Ball_' + String(this._type) + '_' + String(c)).setScale(.105 * this._scene.GameSpriteScale).setOrigin(.5);
    ...
    value: function tweenMovementControl(stopped) {
      ...
      if (this._tweenValue < 1) {
        if (!stopped && this._ballInsertAnimation != 2) {
          if (this._isMover) {
        ...
        /*if (this._tweenValue >= .85) {
            if (nextTS >= this._pointsArrayLength - (64 * this._scene.GameSpriteScale)) {
                if (!this._isDestroying && this._RM.IsPlaying) {
                    this._isDestroying          = true;
                    if (!this._RM.IsGameOver) {
                        this._RM.IsGameOver     = true;
                        this._scene.Sound ? this._scene.sound.play('Failed') : true;
                    }
                }
            }
        }*/
...
module.exports = __webpack_require__(/*! F:\Phaser Game Projects\ZumaHTML5\BallLineSources\src\main.ts */504);
